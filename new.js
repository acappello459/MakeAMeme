...
if (wrapper.innerHTML != ('')){
  ...
  $.ajax({url: "http://version1.api.memegenerator.net//Generators_Select_ByPopular?pageIndex=0&pageSize=25&days=1&apiKey=cd5656de-e732-44b4-aa9d-e41a4fa57c3f",
...
function getImgInfo(array){
  ...
  for(let i  = 0;i<images.length;i++){
    images[i].addEventListener('click', function(){
      ...
      // var imgUrlSplice = imgUrlSplit.splice(5, 0, '400x400')
      // var imgUrl = imgUrlSplit.join('/')
      // console.log(array[i].imageUrl)
